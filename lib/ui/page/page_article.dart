...
import 'package:flutter_app/ui/page/page_article_detail.dart';
...
class _ArticlePageState extends State<ArticlePage> {
  ...
  void onItemClick(itemData) {
    Navigator.of(context).push(new MaterialPageRoute(
        builder: (context) => new ArticleDetailWidget(itemData)));
  }
  ...
  Widget _bannerView() {
    ...
    List<Widget> list = banners.map((item) {
      return GestureDetector(
          ...
          child:
              Image.network(item['imagePath'], fit: BoxFit.cover) //fit 图片充满容器,
          );
    }).toList();
